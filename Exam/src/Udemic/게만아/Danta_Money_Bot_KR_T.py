        ...
        if DantaInfo['IsDone'] == 'N':
            ...
            if stock_amt > 0:
                ...
                if CurrentPrice >= DantaInfo['RevenuePrice'] and DantaInfo['IsTralling'] == 'N':
                    ...
                    line_alert.SendMessage(stock_name + "익절가에 도달! 트레일링 스탑 시작합니다! " + str(stock_revenue_money)+ "(" + str(stock_revenue_rate) + ")") 
        ...
        #트레이딩이 종료 되었다?
            ...
            if DantaInfo['IsDone'] == 'F' and DantaInfo['Round'] == 2 and DantaInfo['IsR2Trigger'] == 'Y':
                ...
                if CurrentPrice >= DantaInfo['MiddlePrice']:
                    ...
                    line_alert.SendMessage(KisKR.GetStockName(stock_code) + " 중앙값을 돌파했어요! 제발 가즈아!!! (1차 손절했단 말이야!) ") 
        ...
        for Stock_Info in FinalInvestStockList:
            ...
            if len(DantaDataList) < MaxStockCnt:
                ...
                if IsMarketOpen == True:
                    ...
                    line_alert.SendMessage(KisKR.GetStockName(stock_code) + " 거래대금 단타 트레이딩 시작합니다!!! ")
                    ...
                    line_alert.SendMessage(KisKR.GetStockName(stock_code) + " 거래대금 단타 트레이딩 시작 주문 완료!!! \n"  + str(DantaDataDict)) 
        ...
        #아직 유효하다 
            ...
            if DantaInfo['IsDone'] == 'F' and DantaInfo['Round'] == 2 and DantaInfo['IsR2Trigger'] == 'N':
                ...
                if CurrentPrice <= DantaInfo['MiddlePrice']:
                    ...
                    line_alert.SendMessage(KisKR.GetStockName(stock_code) + " 중앙값 밑으로 내려왔어요! 이후 돌파하면 매수합시다!! ") 
