...
InvestStockList.append({"stock_code":"133690", "small_ma":19 , "big_ma":31, "invest_rate":0.7}) #TIGER 미국나스닥100
...
InvestStockList.append({"stock_code":"132030", "small_ma":14 , "big_ma":99, "invest_rate":0.1}) #KODEX 골드선물(H)
...
#파일 경로입니다.
invest_file_path = BOT_NAME+"_FileStockList.json"
try:
