...
##########################################################################################################
    ...
    Ma5_before = myUpbit.GetMA(df_day,5,-3) 


    Ma5 = myUpbit.GetMA(df_day,5,-2)   

    Ma6_before = myUpbit.GetMA(df_day,6,-3) 
    Ma6 = myUpbit.GetMA(df_day,6,-2)   
    ...
    Ma20 = myUpbit.GetMA(df_day,20,-2) 
    ...
    Ma60 = myUpbit.GetMA(df_day,60,-2)

    
    Ma70 = myUpbit.GetMA(df_day,70,-2)
